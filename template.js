 ...
 * https://gruntjs.com/
 *
 * Copyright (c) 2013 simonhoye
 */

'use strict';

// Basic template description.
exports.description = 'Create a jQuery plugin using the Twitter Bootstrap class structure, including QUnit unit tests and Bower for package management.';

// Template-specific notes to be displayed before question prompts.
exports.notes = '_Project name_ should not contain "jquery" or "js", be CamelCase and ' +
...
exports.template = function(grunt, init, done) {
  ...
  init.process({type: 'jquery-plugin'}, [
    ...
    props.jqueryjson = props.name + '.jquery-plugin.json';
    props.dependencies = {jquery: props.jquery_version || '>= 1'};

    // create a lowercase version of the class name
